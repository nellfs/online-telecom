        ...
        <div className="new_services_container">
          <div className="text">
            <div>
              ...
              <p>
                Um mundo de possibilidades de entretenimento em vídeo que
                satisfaz os gostos de toda a família. Desde desenhos animados
                para a criançada, até o futebol de domingo.
              </p>
            </div>
            <div>
              <h2>Como Funciona?</h2>
              <p>
                Você pode conectar seus aparelhos como televisores, computadores
                e smartphones direto nos seus serviços preferidos e aproveitar
                as melhores soluções de entretenimento.
              </p>
            </div>
          </div>
